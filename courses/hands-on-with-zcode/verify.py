...
COURSE_SALT = '9432863162868c87'

CHECKPOINTS = [
    {"id": "l01", "gate": "attest", "title": '在桌面工作区复现故障 / Reproduce in the desktop workspace'},
    {"id": "l02", "gate": "attest", "title": '任务契约 / Task contract'},
    {"id": "l03", "gate": "starter-suite", "title": '计划—执行—自检的有界改动 / Plan–execute–self-check, bounded'},
