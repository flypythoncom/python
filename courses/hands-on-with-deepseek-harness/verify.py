...
COURSE_SALT = '2f61c37ef24e027c'

CHECKPOINTS = [
    {"id": "l01", "gate": "attest", "title": '复现故障 / Reproduce the failure'},
    {"id": "l02", "gate": "attest", "title": '任务契约 / Task contract'},
    {"id": "l03", "gate": "starter-suite", "title": '插件化下的有界改动 / Bounded change in a plugin harness'},
    {"id": "l04", "gate": "both-suites", "title": '用轨迹视图核对验证 / Verify against the trajectory'},
