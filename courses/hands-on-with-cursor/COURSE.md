...
> TL;DR: set up Cursor, install the FlyPython Skill, and let the agent fetch
> this course — lesson 1 walks you through all three steps and you download
> nothing. Open an Agent chat and say **"start lesson 1"**. You finish with a working report tool,
