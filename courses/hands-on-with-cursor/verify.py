...
COURSE_SALT = '6b187020c4507d6e'

CHECKPOINTS = [
    {"id": "l01", "gate": "attest", "title": '在编辑器里复现故障 / Reproduce the failure in the editor'},
    {"id": "l02", "gate": "attest", "title": '任务契约与 Agent 模式 / Task contract and Agent mode'},
    {"id": "l03", "gate": "starter-suite", "title": '逐块审 diff 的有界改动 / Bounded change, hunk by hunk'},
    {"id": "l04", "gate": "both-suites", "title": '跑套件与审阅 / Run the suite and review'},
