...
- [大模型评测记录](EVAL_RECORD_cn.md) ([English](EVAL_RECORD.md))：提示词与 Agent benchmark 的结构化评测模版。
- [API 规范契约](API_SPEC_cn.md) ([English](API_SPEC.md))：REST 接口契约定义与错误 Payload 规范。
- [`pyproject.toml` 示例](pyproject.example.toml)：基于 `src/` 布局、pytest、Ruff 与 mypy 的极简代码质量基线。
